...
public class Murmur3 {
	...
	public static long hash64(String val) {
		return hash64(val.getBytes());
	}

	public static int hash32(String val) {
		return hash32(val.getBytes());
	}

	public static String hash128(String val) {
		long[] data = hash128(val.getBytes());
		StringBuilder sb = new StringBuilder(32);
		sb.append(Long.toHexString(data[0]));
		sb.append(Long.toHexString(data[1]));
		return sb.toString();
	}
